...
![Deploy](https://github.com/laboratorys/JSON-Tool/actions/workflows/deploy.yml/badge.svg)
...
> [!TIP]
> Originally created as a V3-compatible alternative to [link-jh] (which lacked V3 support), this project now coexists with [link-jh]'s updated version. Its core functionality is derived from JSON-Handle. Special thanks to [link-jh] for inspiring this work.
...
[<img src="https://raw.githubusercontent.com/alrra/browser-logos/90fdf03c/src/chrome/chrome.svg" width="48" alt="Chrome" valign="middle">][link-chrome] [<img valign="middle" src="https://img.shields.io/chrome-web-store/v/cfjljbmnabbphlgpgmbpmjccjanmheho.svg?label=%20">][link-chrome]
...
[<img src="https://raw.githubusercontent.com/alrra/browser-logos/90fdf03c/src/firefox/firefox.svg" width="48" alt="Firefox" valign="middle">][link-firefox] [<img valign="middle" src="https://img.shields.io/amo/v/json-tool.svg?label=%20">][link-firefox]
